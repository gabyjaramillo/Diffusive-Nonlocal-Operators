%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Solve the system for a range of mesh sizes.
%
% Note that since M has to be even, you can't arbitrarily 
% choose h values. Hence, the range has to be over M values.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

clear;

L = 2;      % Fix the domain size.
...
save('Data/Run1_Mesh.mat','uu','xx','L','error','par','-v7.3'); 